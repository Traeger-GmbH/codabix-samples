...
export class ReadValueNode extends ValueNode {
}
export class ReadFolderNode extends FolderNode {
}
export class ReadDirectoryNode extends DirectoryNode {
}
export class ReadFileNode extends FileNode {
}
export class ReadMethodNode extends MethodNode {
}
