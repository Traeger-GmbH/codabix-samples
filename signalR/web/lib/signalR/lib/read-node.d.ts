...
export declare class ReadValueNode extends ValueNode implements IReadValueNode {
    id: NodeId;
    value?: INodeValue;
}
export declare class ReadFolderNode extends FolderNode implements IReadNode {
    id: NodeId;
}
export declare class ReadDirectoryNode extends DirectoryNode implements IReadNode {
    id: NodeId;
}
export declare class ReadFileNode extends FileNode implements IReadNode {
    id: NodeId;
}
export declare class ReadMethodNode extends MethodNode implements IReadNode {
    id: NodeId;
}
export declare type ReadNode = ReadValueNode | ReadFolderNode | ReadDirectoryNode | ReadFileNode | ReadMethodNode;
